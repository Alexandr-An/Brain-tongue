...
public class Level4_accents extends AppCompatActivity {
Dialog dialog;
Dialog dialogEnd;
...
public int count = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textviewdescription.setText(R.string.level4_accents);
        ...
        buttonClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level4_accents.this, GameLevels_accents.class);
...
//        textdescriptionend.setText(R.string.accents);
...
final int[] progress={
        ...
        final Animation a = AnimationUtils.loadAnimation(Level4_accents.this, R.anim.alpha);
